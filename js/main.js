...
function check_answer_yes() {
  ...
  q1Input.classList.add('show-block') ;
  q2Yes.classList.add('show') ;
  q1Input.classList.remove('hide') ;
  q2Yes.classList.remove('hide');
  q2no.classList.remove('show');
  q2no.classList.add('hide');
  q2no.classList.add('hide') ;
  q2no.classList.remove('show');
  q3Yes.classList.add('hide');
  q3Yes.classList.remove('show');
  q3no.classList.add('hide');
  q3no.classList.remove('show');
  q3no_2.classList.add('hide');
  q3no_2.classList.remove('show');
  q3no_1.classList.add('hide');
  q3no_1.classList.remove('show');
  q1Date.classList.add('hide');
  q1Date.classList.remove('show');
  q4no.classList.add('hide');
  q4no.classList.remove('show');
  q4YesYes.classList.add('hide');
  q4YesYes.classList.remove('show');
...
function check_answer_yes_2() {
  ...
  q4Yes.classList.add('show');
  q4Yes.classList.remove('hide');
  q4no.classList.remove('show');
  q4no.classList.add('hide'); 
  q3Yes.classList.remove('show');
  q3Yes.classList.add('hide');
...
function check_answer_no_2() {
  ...
  q4no.classList.add('show');
  q4no.classList.remove('hide');
  q4Yes.classList.remove('show');
  q4Yes.classList.add('hide'); 
...
function check_answer_yes_4_no() {
  if(document.querySelector('input[name="gridRadiosq4-no"]:checked').value){
    q3no.classList.add('hide');
    q3no.classList.remove('show')
  }
}
function check_answer_no_4_no() {
  if(document.querySelector('input[name="gridRadiosq4-no"]:checked').value){
    q3no.classList.add('show');
    q3no.classList.remove('hide')
  }
}
function check_answer_no()
{
  if(document.querySelector('input[name="gridRadiosq1"]:checked').value){
  q2no.classList.add('hide') ;
  q2no.classList.remove('remove');
  q3no_2.classList.add('show');
  q3no_2.classList.remove('hide');
  q3no_1.classList.add('show');
  q3no_1.classList.remove('hide');
  q3no.classList.add('hide');
  q3no.classList.remove('show');
  q1Date.classList.add('show');
  q1Date.classList.remove('hide');
  q4YesYes.classList.add('show');
  q4YesYes.classList.remove('hide');
  q4Yes.classList.add('hide');
  q4Yes.classList.remove('show');
  q2Date.classList.add('show');
  q2Date.classList.remove('hide');
  q1Input.classList.add('hide');
  q2Yes.classList.remove('show') ;
  q2Yes.classList.add('hide') ;
  q4Yes.classList.add('hide');
  q4Yes.classList.remove('show');
  q4no.classList.add('hide');
  q4no.classList.remove('show');
